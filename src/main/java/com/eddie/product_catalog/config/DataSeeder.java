...
import com.eddie.product_catalog.Models.Catalog;
...
public class DataSeeder implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        phone.setCategory(Catalog.ELECTRONICS);
        ...
        laptop.setCategory(Catalog.ELECTRONICS);
        ...
        jacket.setCategory(Catalog.CLOTHING);
        ...
        coffeeMug.setCategory(Catalog.HOME);
        ...
        blender.setCategory(Catalog.HOME);
